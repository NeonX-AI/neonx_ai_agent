...
export declare function rememberMessengerAssistantPrompt(senderId: string, text: string, now?: number, messageId?: string): void;
export declare function resolveMessengerImagePromptFromUserText(params: {
    senderId: string;
    text: string;
    now?: number;
